...
function AdminManage() {
    const { Token_login, AllUser } = useSelector((state) => state.productStore);
    ...
    return (
        <>
            {Token_login ? (<div className=" bg-[#FCA5A5] ">
                <div className="mx-auto w-[90%] p-2 bg-[white] rounded-sm  ">
                        ...
                        <div className=" shadow-md sm:rounded-lg">
                            ...
                            {AllUser && (
                                    <table className="min-w-full divide-y divide-gray-200 table-fixed dark:divide-gray-700">
                                        ...
                                        {AllUser.map((ele) => (
                                                <tr key={ele.email}>  {/* Add a unique key for each row */}
                                                    <td>{ele.username}</td>
                                                    <td>{ele.userType}</td>
                                                    <td>{ele.email}</td>
                                                    <td>
