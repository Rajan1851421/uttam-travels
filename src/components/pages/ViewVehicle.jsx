                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center overflow-x-hidden overflow-y-auto outline-none focus:outline-none">
                    <div className="relative w-auto max-w-3xl mx-auto my-6">
                        ...
                        <div className="relative flex flex-col w-full p-2 bg-white border-0 rounded-lg shadow-lg outline-none focus:outline-none">
                            ...
                            {ViewVechile && ViewVechile.Vehicle && (
                                <p className="text-center text-md sm:text-sm lg-text-md font-bold underline uppercase ">
                                    {ViewVechile.Vehicle.carName}
                                </p>
                            )}
                            <div>
                                <img src={ViewVechile && ViewVechile.Vehicle && ViewVechile.Vehicle.image} alt="image" />
                            </div>
                            {ViewVechile && ViewVechile.Vehicle && (
                                <p className="text-center text-md sm:text-sm lg-text-md font-bold ">
                                    {`Rate : ${ViewVechile.Vehicle.rate} Km`}
                                </p>
                            )}
